            ...
            if (isset($_GET["action"])) {
                ...
                switch ($action) {
                    ...
                    case "search_channel":
                        ...
                        $channelReport = $this->m_channel_analytics->GetAllChannelReport();
                        $UserIDSearch = isset($_POST["UserIDSearch"]) ? trim($_POST["UserIDSearch"]) : '';
                        if ($UserIDSearch != "") {
                            if ($UserIDSearch != "all") {
                                $arr_chanel = $this->m_channel_analytics->GetChannelSearchByUserID($UserIDSearch);
                            } else {
                                $arr_chanel = $this->m_channel_analytics->GetAllChannel($_SESSION["UserId"]);//
                            }
                        }
                ...
                $arr_chanel = $this->m_channel_analytics->GetChannelSearchByUserID($arr_user[0]['ID']);
                $channelReport = $this->m_channel_analytics->GetAllChannelReport();
